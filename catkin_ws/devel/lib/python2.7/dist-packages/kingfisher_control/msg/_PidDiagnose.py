...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_8f().pack(_x.P, _x.I, _x.D, _x.PID, _x.Error, _x.Setpoint, _x.Derivative, _x.Integral))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.P, _x.I, _x.D, _x.PID, _x.Error, _x.Setpoint, _x.Derivative, _x.Integral,) = _get_struct_8f().unpack(str[start:end])
      return self
